...
<body>
	...
	Info info = new Info();
	%>
	<p>会員番号</p><%=request.getParameter("memberId")%>
	<form action="../update/update" method="post">
		<p>
			■更新内容<br>
		<p>
			■名前<br> 姓<input type="text" name="lastName"> 名<input
				type="text" name="firstName">
		</p>
		<p>
			■性別<br> <input type="radio" name="sex" value="男">男 <input
				type="radio" name="sex" value="女">女
		</p>
		<p>
			■生年月日<br> <select name="bitrhYear">
